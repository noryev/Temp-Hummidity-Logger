...
<head>
  <title>Line Chart | Hummidity-Temperature</title>
...
<body>
    <div style="text-align:center;"><b>Temp+Hummidity</b><br>Real Time Data Humidity, Temperature Logging with Graphs on ESP8266</div>
